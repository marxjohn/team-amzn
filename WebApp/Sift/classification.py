...
data_test = get_cluster_data("2013-02-01", "2013-03-03")

print('data loaded')

categories = data_train.cluster_list    # for case categories == None
...
results.append(classify(L1LinearSVC(), data_test))
...
if IS_UPLOAD_ENBABLED:
    associate_post_with_cluster(data_test, len(categories))